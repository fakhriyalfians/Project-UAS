...
<?php
    ...
    if(isset($_POST['Edit']))
    {
        ...
        $namac = $_POST['inputnama'];
        $provinsiID = $_POST["provinsiID"];


        mysqli_query($connection, "update kabupaten set namakabupaten='$namakabupaten',
        provinsiID ='$provinsiID'
        where kabupatenID = '$kabkode'");
...
<div class="row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit["kabupatenID"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit["namakabupaten"]?>">
    </div>
  </div>
            ...
            if(isset($_POST["kirim"]))
            {
                ...
                { ?>
                    <tr>
                        ...
                        <!-- icon edit delet-->
                        <td>
                            <a href="areaedit.php?ubah=<?php echo $row["kabupatenID"]?>" 
                ...
                <td>
                        <a href="areahapus.php?hapus=<?php echo $row["kabupatenID"]?>" 
