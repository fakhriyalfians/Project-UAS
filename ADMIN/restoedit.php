...
<?php  
    ...
    if (isset($_POST["Batal"])) {
		header("location:resoran.php");
	}
	if (isset($_POST['Edit'])) 
    {
        if(isset($_REQUEST['inputkode']))
        {
            $koderesto = $_REQUEST['inputkode'];
        }
...
/*
        ...
        mysqli_query($connection, "update restoran set restonama='$namaresto',
        deskripsi='$deskripsi', areaID='$kodearea', provinsiID='$provinsiarea'
    ...
    $koderesto = $_GET["ubah"];
    $editresto = mysqli_query($connection, "select * from restoran
    where restoID = '$koderesto'");
		...
		<form method="POST" enctype="multipart/form-data">
			<div class="form-group row">
				...
				<div class="col-sm-10">
                    ...
                    value="<?php echo $rowedit["restoID"]?>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
                    ...
                    value="<?php echo $rowedit["restonama"]?>">
				</div>
			</div>
        ...
        <?php } ?>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
                    ...
                    <img src="images/<?php echo $rowedit['fotoresto'] ?>" style="width: 200px; height: 100px;">
