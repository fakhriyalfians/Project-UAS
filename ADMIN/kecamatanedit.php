...
<?php
    ...
    if(isset($_POST['Edit']))
    {
        ...
        mysqli_query($connection, "update kecamatan set namakecamatan='$namakecamatan',
        kabupatenID ='$KabupatenID'
        where kecamatanID = '$keckode'");
...
<div class="row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit["kecamatanID"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit["namakecamatan"]?>">
    </div>
  </div>
            ...
            if(isset($_POST["kirim"]))
            {
                ...
                { ?>
                    <tr>
                        ...
                        <!-- icon edit delet-->
                        <td>
                            <a href="areaedit.php?ubah=<?php echo $row["kecamatanID"]?>" 
                ...
                <td>
                        <a href="areahapus.php?hapus=<?php echo $row["kecamatanID"]?>" 
